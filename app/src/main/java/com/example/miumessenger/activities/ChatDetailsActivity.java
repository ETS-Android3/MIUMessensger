...
import com.example.miumessenger.adapters.MessagesAdapter;
                ...
                if(snapshot.exists()) {
                    ...
                    if(!status.isEmpty()) {
                        if(status.equals("Offline")) {
                            ...
                            binding.activeStatus.setText(status);
        ...
        binding.sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(messageText.isEmpty()){
                    binding.messageBox.setError("Type a message!");
                    return;
                }
                            ...
                            if(task.isSuccessful()) {
                                reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        Toast.makeText(ChatDetailsActivity.this,"Upload Completed", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
